...
$\bullet \quad$ Punish = False. This means that guardians don't receive negative feedback for links that are not in the knower's database of `truths'.

In a real-life application of Semantic Sky this will be a nonexisting issue, but in a test, we have to choose which items we give negative feedback to. In this test I chose not to give negative feedback for all links currently not in Starfish and mistakenly captured by the guardians as similar. Maybe in the future it will be interesting to see how the outcome changes setting this flag to true.
...
\begingroup%
  ...
  \begin{picture}(1,0.50366032)%
    \put(-0.18,0){\includegraphics[width=\unitlength]{/home/pietro/Perceptum/code/starfish/similarity/SemanticSky/tests_output/oldtests/average_belief_in_true_links_median_no_punish_lr02_FULL.pdf}\hspace{-300pt} Figure \themyfigure}%
  \end{picture}%
\endgroup%
...
\begingroup%
  ...
  \makeatother%
  \begin{picture}(1,0.50366032)%
    \put(-0.18,0){\includegraphics[width=\unitlength]{/home/pietro/Perceptum/code/starfish/similarity/SemanticSky/tests_output/oldtests/average_belief_in_false_links_median_no_punish_lr02_FULL.pdf}\hspace{-300pt} Figure \themyfigure}%
  \end{picture}%
\endgroup%
...
\begingroup%
  ...
  \makeatother%
  \begin{picture}(1,0.50366032)%
    \put(-0.18,0){\includegraphics[width=\unitlength]{/home/pietro/Perceptum/code/starfish/similarity/SemanticSky/tests_output/oldtests/guardians_regrets_median_no_punish_lr02_FULL.pdf}
    \hspace{-300pt} Figure \themyfigure }%
  \end{picture}%
\endgroup%

Regret (at stage $n$, for angel $A$) was computed as follows: $sum$($(1 - A.belief\_in(x))$ for $x$ in $all\_truths$ ), where $all\_truths$ is a list of all links actually existing in Starfish (that is: the Knower's database).
...
The same test, with different parameters (learning rate $= 0.8$, update rule = \emph{average} of all feedback) yields comparable results (though perhaps a bit less nice):
...
\begingroup%
  ...
  \makeatother%
  \begin{picture}(1,0.50366032)%
    \put(-0.18,0){\includegraphics[width=\unitlength]{/home/pietro/Perceptum/code/starfish/similarity/SemanticSky/tests_output/oldtests/average_belief_in_true_links_average_no_punish_lr08_FULL.pdf}\hspace{-330pt} Figure \themyfigure : true links beliefs }%
  \end{picture}%
\endgroup%
...
\begingroup%
  ...
  \makeatother%
  \begin{picture}(1,0.50366032)%
    \put(-0.18,0){\includegraphics[width=\unitlength]{/home/pietro/Perceptum/code/starfish/similarity/SemanticSky/tests_output/oldtests/average_belief_in_false_links_average_no_punish_lr08_FULL.pdf}\hspace{-330pt} Figure \themyfigure : false links beliefs }%
  \end{picture}%
\endgroup%
...
\begingroup%
  ...
  \makeatother%
  \begin{picture}(1,0.50366032)%
    \put(-0.18,0){\includegraphics[width=\unitlength]{/home/pietro/Perceptum/code/starfish/similarity/SemanticSky/tests_output/oldtests/guardians_regrets_average_no_punish_lr08_FULL.pdf}\hspace{-300pt} Figure \themyfigure : regrets }%
...
\begin{itemize}
\item Median, learning rates 0.2, 0.4, 0.5, 0.8, 1.

\item Average, learning rates 0.4, 0.8, 1.
...
The second test was altogether different. Instead of emptying the sky and adding back clouds, we first make a full analysis, and then slowly give feedback, monitoring the subsequent evolution of the belief state and the trustworthiness of the angels.




\part{Appendices.}
\section{Appendix 1: punishing.}
...
\begingroup%
  ...
  \makeatother%
  \begin{picture}(1,0.50366032)%
    \put(-0.18,0){\includegraphics[width=\unitlength]{/home/pietro/Perceptum/code/starfish/similarity/SemanticSky/tests_output/newtests/regret_of_angels_median_lr05_punish_fulltest.pdf}\hspace{-300pt} Figure \themyfigure : regrets}%
  \end{picture}%
\endgroup%
