...
The angels whose regrets don't decrease are the tag-similarity angels. Currently lacking Starfish any data about how similar two tags are, no link of that type (tag-to-tag) is available in Starfish, and all the feedback will be negative.
