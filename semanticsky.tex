...
\begingroup%
  ...
  \begin{picture}(1,0.50366032)%
    \put(-0.18,0){\includegraphics[width=\unitlength]{/home/pietro/Perceptum/code/starfish/similarity/SemanticSky/tests_output/average_belief_in_true_links_median_no_punish_lr02_FULL.pdf}\hspace{-300pt} Figure \themyfigure}%
  \end{picture}%
\endgroup%
...
\begingroup%
  ...
  \makeatother%
  \begin{picture}(1,0.50366032)%
    \put(-0.18,0){\includegraphics[width=\unitlength]{/home/pietro/Perceptum/code/starfish/similarity/SemanticSky/tests_output/average_belief_in_false_links_median_no_punish_lr02_FULL.pdf}\hspace{-300pt} Figure \themyfigure}%
  \end{picture}%
\endgroup%
...
\begingroup%
  ...
  \makeatother%
  \begin{picture}(1,0.50366032)%
    \put(-0.18,0){\includegraphics[width=\unitlength]{/home/pietro/Perceptum/code/starfish/similarity/SemanticSky/tests_output/guardians_regrets_median_no_punish_lr02_FULL.pdf}
...
\begingroup%
  ...
  \makeatother%
  \begin{picture}(1,0.50366032)%
    \put(-0.18,0){\includegraphics[width=\unitlength]{/home/pietro/Perceptum/code/starfish/similarity/SemanticSky/tests_output/average_belief_in_true_links_average_no_punish_lr08_FULL.pdf}\hspace{-330pt} Figure \themyfigure : true links beliefs }%
  \end{picture}%
\endgroup%
...
\begingroup%
  ...
  \makeatother%
  \begin{picture}(1,0.50366032)%
    \put(-0.18,0){\includegraphics[width=\unitlength]{/home/pietro/Perceptum/code/starfish/similarity/SemanticSky/tests_output/average_belief_in_false_links_average_no_punish_lr08_FULL.pdf}\hspace{-330pt} Figure \themyfigure : false links beliefs }%
  \end{picture}%
\endgroup%
...
\begingroup%
  ...
  \makeatother%
  \begin{picture}(1,0.50366032)%
    \put(-0.18,0){\includegraphics[width=\unitlength]{/home/pietro/Perceptum/code/starfish/similarity/SemanticSky/tests_output/guardians_regrets_average_no_punish_lr08_FULL.pdf}\hspace{-300pt} Figure \themyfigure : regrets }%
	
  \end{picture}%
\endgroup%

\vspace{1cm}
Summing up, tests were ran with the following parameters:
...
\item Median and average, learning rate 0.2, punish = True\footnote{This means that feedback was given not on known truths but also on unknown pairs (which, we remind, are assumed to have similarity $0$').}.
\end{itemize}
